var Kt=Object.defineProperty;var Qt=(t,e,n)=>e in t?Kt(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n;var m=(t,e,n)=>Qt(t,typeof e!="symbol"?e+"":e,n);(function(){try{var t=typeof window<"u"?window:typeof global<"u"?global:typeof globalThis<"u"?globalThis:typeof self<"u"?self:{};t.SENTRY_RELEASE={id:"b0399362939cd965025ddcb13f12b6edcea1b1ee"};var e=new t.Error().stack;e&&(t._sentryDebugIds=t._sentryDebugIds||{},t._sentryDebugIds[e]="9c6e655b-935c-4ece-8deb-b6b61bb92514",t._sentryDebugIdIdentifier="sentry-dbid-9c6e655b-935c-4ece-8deb-b6b61bb92514")}catch{}})();(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const l of s.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&r(l)}).observe(document,{childList:!0,subtree:!0});function n(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(i){if(i.ep)return;i.ep=!0;const s=n(i);fetch(i.href,s)}})();class Xt extends HTMLElement{constructor(){super()}connectedCallback(){this.innerHTML=`
...
${o}`:o,i=i?`${i}
${c}`:c;const p=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(c,s,!0),this.lexer.state.top=p,n.length===0)break;const h=s.at(-1);if((h==null?void 0:h.type)==="code")break;if((h==null?void 0:h.type)==="blockquote"){const b=h,d=b.raw+`
`+n.join(`
`),k=this.blockquote(d);s[s.length-1]=k,r=r.substring(0,r.length-b.raw.length)+k.raw,i=i.substring(0,i.length-b.text.length)+k.text;break}else if((h==null?void 0:h.type)==="list"){const b=h,d=b.raw+`
`+n.join(`
`),k=this.list(d);s[s.length-1]=k,r=r.substring(0,r.length-h.raw.length)+k.raw,i=i.substring(0,i.length-b.raw.length)+k.raw,n=d.substring(s.at(-1).raw.length).split(`
...
`,1)[0].replace(this.rules.other.listReplaceTabs,ue=>" ".repeat(3*ue.length)),h=t.split(`
`,1)[0],b=!p.trim(),d=0;if(this.options.pedantic?(d=2,c=p.trimStart()):b?d=e[1].length+1:(d=e[2].search(this.rules.other.nonSpaceChar),d=d>4?1:d,c=p.slice(d),d+=e[1].length),b&&this.rules.other.blankLine.test(h)&&(o+=h+`
`,t=t.substring(h.length+1),u=!0),!u){const ue=this.rules.other.nextBulletRegex(d),Ue=this.rules.other.hrRegex(d),Ze=this.rules.other.fencesBeginRegex(d),Ye=this.rules.other.headingBeginRegex(d),Vt=this.rules.other.htmlBeginRegex(d);for(;t;){const he=t.split(`
`,1)[0];let O;if(h=he,this.options.pedantic?(h=h.replace(this.rules.other.listReplaceNesting,"  "),O=h):O=h.replace(this.rules.other.tabCharGlobal,"    "),Ze.test(h)||Ye.test(h)||Vt.test(h)||ue.test(h)||Ue.test(h))break;if(O.search(this.rules.other.nonSpaceChar)>=d||!h.trim())c+=`
`+O.slice(d);else{if(b||p.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||Ze.test(p)||Ye.test(p)||Ue.test(p))break;c+=`
`+h}!b&&!h.trim()&&(b=!0),o+=he+`
`,t=t.substring(he.length+1),p=O.slice(d)}}i.loose||(l?i.loose=!0:this.rules.other.doubleBlankLine.test(o)&&(l=!0));let k=null,Fe;this.options.gfm&&(k=this.rules.other.listIsTask.exec(c),k&&(Fe=k[0]!=="[ ] ",c=c.replace(this.rules.other.listReplaceTask,""))),i.items.push({type:"list_item",raw:o,task:!!k,checked:Fe,loose:!1,text:c,tokens:[]}),i.raw+=o}const a=i.items.at(-1);if(a)a.raw=a.raw.trimEnd(),a.text=a.text.trimEnd();else return;i.raw=i.raw.trimEnd();for(let u=0;u<i.items.length;u++)if(this.lexer.state.top=!1,i.items[u].tokens=this.lexer.blockTokens(i.items[u].text,[]),!i.loose){const o=i.items[u].tokens.filter(p=>p.type==="space"),c=o.length>0&&o.some(p=>this.rules.other.anyLine.test(p.raw));i.loose=c}if(i.loose)for(let u=0;u<i.items.length;u++)i.items[u].loose=!0;return i}}html(t){const e=this.rules.block.html.exec(t);if(e)return{type:"html",block:!0,raw:e[0],pre:e[1]==="pre"||e[1]==="script"||e[1]==="style",text:e[0]}}def(t){const e=this.rules.block.def.exec(t);if(e){const n=e[1].toLowerCase().replace(this.rules.other.multipleSpaceGlobal," "),r=e[2]?e[2].replace(this.rules.other.hrefBrackets,"$1").replace(this.rules.inline.anyPunctuation,"$1"):"",i=e[3]?e[3].substring(1,e[3].length-1).replace(this.rules.inline.anyPunctuation,"$1"):e[3];return{type:"def",tag:n,raw:e[0],href:r,title:i}}}table(t){var l;const e=this.rules.block.table.exec(t);if(!e||!this.rules.other.tableDelimiter.test(e[2]))return;const n=Qe(e[1]),r=e[2].replace(this.rules.other.tableAlignChars,"").split("|"),i=(l=e[3])!=null&&l.trim()?e[3].replace(this.rules.other.tableRowBlankLine,"").split(`
...
`+a.raw,o.text+=`
`+a.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=o.text):n.push(a);continue}if(e){const o="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(o);break}else throw new Error(o)}}return this.state.top=!0,n}inline(e,n=[]){return this.inlineQueue.push({src:e,tokens:n}),n}inlineTokens(e,n=[]){var a,u,o;let r=e,i=null;if(this.tokens.links){const c=Object.keys(this.tokens.links);if(c.length>0)for(;(i=this.tokenizer.rules.inline.reflinkSearch.exec(r))!=null;)c.includes(i[0].slice(i[0].lastIndexOf("[")+1,-1))&&(r=r.slice(0,i.index)+"["+"a".repeat(i[0].length-2)+"]"+r.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(i=this.tokenizer.rules.inline.anyPunctuation.exec(r))!=null;)r=r.slice(0,i.index)+"++"+r.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);for(;(i=this.tokenizer.rules.inline.blockSkip.exec(r))!=null;)r=r.slice(0,i.index)+"["+"a".repeat(i[0].length-2)+"]"+r.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);let s=!1,l="";for(;e;){s||(l=""),s=!1;let c;if((u=(a=this.options.extensions)==null?void 0:a.inline)!=null&&u.some(h=>(c=h.call({lexer:this},e,n))?(e=e.substring(c.raw.length),n.push(c),!0):!1))continue;if(c=this.tokenizer.escape(e)){e=e.substring(c.raw.length),n.push(c);continue}if(c=this.tokenizer.tag(e)){e=e.substring(c.raw.length),n.push(c);continue}if(c=this.tokenizer.link(e)){e=e.substring(c.raw.length),n.push(c);continue}if(c=this.tokenizer.reflink(e,this.tokens.links)){e=e.substring(c.raw.length);const h=n.at(-1);c.type==="text"&&(h==null?void 0:h.type)==="text"?(h.raw+=c.raw,h.text+=c.text):n.push(c);continue}if(c=this.tokenizer.emStrong(e,r,l)){e=e.substring(c.raw.length),n.push(c);continue}if(c=this.tokenizer.codespan(e)){e=e.substring(c.raw.length),n.push(c);continue}if(c=this.tokenizer.br(e)){e=e.substring(c.raw.length),n.push(c);continue}if(c=this.tokenizer.del(e)){e=e.substring(c.raw.length),n.push(c);continue}if(c=this.tokenizer.autolink(e)){e=e.substring(c.raw.length),n.push(c);continue}if(!this.state.inLink&&(c=this.tokenizer.url(e))){e=e.substring(c.raw.length),n.push(c);continue}let p=e;if((o=this.options.extensions)!=null&&o.startInline){let h=1/0;const b=e.slice(1);let d;this.options.extensions.startInline.forEach(k=>{d=k.call({lexer:this},b),typeof d=="number"&&d>=0&&(h=Math.min(h,d))}),h<1/0&&h>=0&&(p=e.substring(0,h+1))}if(c=this.tokenizer.inlineText(p)){e=e.substring(c.raw.length),c.raw.slice(-1)!=="_"&&(l=c.raw.slice(-1)),s=!0;const h=n.at(-1);(h==null?void 0:h.type)==="text"?(h.raw+=c.raw,h.text+=c.text):n.push(c);continue}if(e){const h="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(h);break}else throw new Error(h)}}return n}},te=class{constructor(t){m(this,"options");m(this,"parser");this.options=t||$}space(t){return""}code({text:t,lang:e,escaped:n}){var s;const r=(s=(e||"").match(x.notSpaceStart))==null?void 0:s[0],i=t.replace(x.endingNewline,"")+`
...
Please report this to https://github.com/markedjs/marked.`,t){const r="<p>An error occurred:</p><pre>"+v(n.message+"",!0)+"</pre>";return e?Promise.resolve(r):r}if(e)return Promise.reject(n);throw n}}},I=new Hn;function f(t,e){return I.parse(t,e)}f.options=f.setOptions=function(t){return I.setOptions(t),f.defaults=I.defaults,xt(f.defaults),f};f.getDefaults=Se;f.defaults=$;f.use=function(...t){return I.use(...t),f.defaults=I.defaults,xt(f.defaults),f};f.walkTokens=function(t,e){return I.walkTokens(t,e)};f.parseInline=I.parseInline;f.Parser=T;f.parser=T.parse;f.Renderer=te;f.TextRenderer=$e;f.Lexer=S;f.lexer=S.lex;f.Tokenizer=ee;f.Hooks=X;f.parse=f;f.options;f.setOptions;f.use;f.walkTokens;f.parseInline;T.parse;S.lex;const jn=t=>{const e=t.replace(/^#?\/?/,"");return e===""||e==="home"?"landing":"documentation"},Gn=t=>({landing:{type:"landing",showBreadcrumb:!1,showTableOfContents:!1,showNavigation:!1},documentation:{type:"documentation",showBreadcrumb:!0,showTableOfContents:!0,showNavigation:!0}})[t],ae=()=>Gn(jn(window.location.hash));function N(t){return document.getElementById(t)}function Je(t){const e=document.getElementById(t);if(!e)throw new Error(`Required element not found: #${t}`);return e}f.setOptions({gfm:!0,breaks:!0});const Fn=["card-component","button-component","home-link-card-component"],Un=Fn.join("|"),et=new RegExp(`^<(${Un})([\\s\\S]*?)(?:>([\\s\\S]*?)<\\/\\1>|\\s*\\/>)`,"i"),Zn={name:"custom-block-tag",level:"block",start(t){var e;return(e=t.match(et))==null?void 0:e.index},tokenizer(t){const e=et.exec(t);if(e)return{type:"html",raw:e[0],text:e[0]}}};f.use({extensions:[Zn]});async function Yn(t,e){const n=await f.parse(t);e.innerHTML=n}async function Wn(t){try{const e=await fetch(`/docs/${t}.md`);if(!e.ok)throw new Error(`❌ 페이지를 찾을 수 없습니다: ${t}`);const n=await e.text(),r=e.headers.get("content-type");if(r&&r.includes("text/html"))throw new Error(`❌ 요청된 경로가 HTML을 반환합니다: ${t}`);const i=n.trim();if(i.startsWith("<!DOCTYPE html>")||i.startsWith("<html>")||i.startsWith("<title>")&&i.includes("</title>"))throw new Error(`❌ 요청된 경로가 Markdown이 아닌 HTML을 반환합니다: ${t}`);const s=Je("content");s.innerHTML="",await Yn(n,s)}catch{const e=Je("content");e.innerHTML=`
    ...
    `}}async function Vn(){const e=ae().type==="landing"?"home":location.hash.substring(2)||"home";await Wn(e)}const Kn=t=>new IntersectionObserver(e=>{const n=e.filter(r=>r.isIntersecting).sort((r,i)=>r.boundingClientRect.top-i.boundingClientRect.top)[0];if(n){const r=n.target.id;Object.entries(t).forEach(([i,s])=>{i===r?s.classList.add("border-l-2","border-blue-500"):s.classList.remove("border-l-2","border-blue-500")})}},{rootMargin:"-60px 0px -60% 0px",threshold:.8}),Qn=()=>{const t=N("content"),e=N("toc");if(!t||!e){console.warn("TOC 초기화 실패: content 또는 toc 요소를 찾을 수 없습니다.");return}e.innerHTML="";const n=t.querySelectorAll("h2, h3");if(n.length===0)return;const r=document.createElement("p"),i=document.createElement("ul");r.classList.add("text-black","font-normal","text-lg","pb-5"),r.textContent="Table of contents";const s={};n.forEach((a,u)=>{const o=document.createElement("li");o.classList.add("max-w-64","font-extralight","hover:bg-gray-300","hover:font-semibold","cursor-pointer");const c=document.createElement("button");c.classList.add("flex","justify-start","items-stretch","p-1","cursor-pointer","w-full","truncate"),c.setAttribute("aria-label",a.textContent||"Heading Link"),c.setAttribute("role","link");const p=a.textContent||"";c.textContent=p.length>30?p.substring(0,30)+"...":p,c.addEventListener("click",h=>{h.preventDefault();const b=a.getBoundingClientRect(),d=window.scrollY+b.top-60;window.scrollTo({top:d,behavior:"smooth"})}),o.appendChild(c),i.appendChild(o),a.tagName==="H3"&&o.classList.add("pl-3"),a.id=`${u}`,s[a.id]=o}),e.appendChild(r),e.appendChild(i);const l=Kn(s);n.forEach(a=>l.observe(a))};async function Xn(){try{const t=await fetch("/data/breadcrumb.json");if(!t.ok)throw new Error("Failed to load breadcrumb translation data");return await t.json()}catch(t){return console.error("Error loading breadcrumb translation data:",t),{}}}function Jn(t,e,n){let r=n[t[0]];if(!r)return null;for(let i=1;i<=e;i++)if(r.children&&r.children[t[i]])r=r.children[t[i]];else return null;return r}async function er(){const t=window.location.hash.slice(1),e=await Xn(),n=t.split("/").filter(s=>s!==""),r=[{name:"홈",path:"/",linkable:!0}];let i="";return n.forEach((s,l)=>{const a=Jn(n,l,e);i+=`/${s}`,a&&r.push({name:a.name,path:`#${i}`,linkable:a.linkable})}),r}function tr(t){const e=document.createElement("nav");e.id="breadcrumbs",e.className="pb-3 flex min-w-0 items-center gap-2 text-gray-400 dark:text-gray-300";const n=t.map((r,i)=>i===t.length-1?`<span class="truncate">${r.name}</span>`:r.linkable?`<a href="${r.path}" class="link truncate">${r.name}</a> / `:`<span class="truncate text-blue-500">${r.name}</span> / `).join("");return e.innerHTML=n,e}function nr(){const t=document.getElementById("breadcrumbs");t&&t.remove()}async function rr(){const t=N("content");if(!t){console.warn("Breadcrumb 초기화 실패: content 요소를 찾을 수 없습니다.");return}nr();const e=await er(),n=tr(e);t.insertBefore(n,t.firstChild)}function ir(t){const e=N("sidebar");e&&(e.style.display=t.showNavigation?"":"none");const n=N("aside-toc");n&&(n.style.display=t.showTableOfContents?"":"none");const r=N("content");r&&(r.classList.remove("max-w-5xl","mx-auto"),t.type==="landing"&&r.classList.add("max-w-5xl","mx-auto"))}const w=typeof __SENTRY_DEBUG__>"u"||__SENTRY_DEBUG__,E=globalThis,G="10.37.0";function U(){return Me(E),E}function Me(t){const e=t.__SENTRY__=t.__SENTRY__||{};return e.version=e.version||G,e[G]=e[G]||{}}function Z(t,e,n=E){const r=n.__SENTRY__=n.__SENTRY__||{},i=r[G]=r[G]||{};return i[t]||(i[t]=e())}const sr="Sentry Logger ",tt={};function ar(t){if(!("console"in E))return t();const e=E.console,n={},r=Object.keys(tt);r.forEach(i=>{const s=tt[i];n[i]=e[i],e[i]=s});try{return t()}finally{r.forEach(i=>{e[i]=n[i]})}}function or(){Ne().enabled=!0}function lr(){Ne().enabled=!1}function At(){return Ne().enabled}function cr(...t){Pe("log",...t)}function ur(...t){Pe("warn",...t)}function hr(...t){Pe("error",...t)}function Pe(t,...e){w&&At()&&ar(()=>{E.console[t](`${sr}[${t}]:`,...e)})}function Ne(){return w?Z("loggerSettings",()=>({enabled:!1})):{enabled:!1}}const R={enable:or,disable:lr,isEnabled:At,log:cr,warn:ur,error:hr},pr=Object.prototype.toString;function It(t,e){return pr.call(t)===`[object ${e}]`}function dr(t){return It(t,"String")}function fr(t){return It(t,"Object")}function gr(t){return!!(t!=null&&t.then&&typeof t.then=="function")}function br(t,e,n){try{Object.defineProperty(t,e,{value:n,writable:!0,configurable:!0})}catch{w&&R.log(`Failed to add non-enumerable property "${e}" to object`,t)}}let M;function oe(t){if(M!==void 0)return M?M(t):t();const e=Symbol.for("__SENTRY_SAFE_RANDOM_ID_WRAPPER__"),n=E;return e in n&&typeof n[e]=="function"?(M=n[e],M(t)):(M=null,t())}function ve(){return oe(()=>Math.random())}function mr(){return oe(()=>Date.now())}function kr(t,e=0){return typeof t!="string"||e===0||t.length<=e?t:`${t.slice(0,e)}...`}function xr(){const t=E;return t.crypto||t.msCrypto}let pe;function vr(){return ve()*16}function z(t=xr()){try{if(t!=null&&t.randomUUID)return oe(()=>t.randomUUID()).replace(/-/g,"")}catch{}return pe||(pe="10000000100040008000"+1e11),pe.replace(/[018]/g,e=>(e^(vr()&15)>>e/4).toString(16))}const $t=1e3;function Mt(){return mr()/$t}function yr(){const{performance:t}=E;if(!(t!=null&&t.now)||!t.timeOrigin)return Mt;const e=t.timeOrigin;return()=>(e+oe(()=>t.now()))/$t}let nt;function ze(){return(nt??(nt=yr()))()}function wr(t,e={}){if(e.user&&(!t.ipAddress&&e.user.ip_address&&(t.ipAddress=e.user.ip_address),!t.did&&!e.did&&(t.did=e.user.id||e.user.email||e.user.username)),t.timestamp=e.timestamp||ze(),e.abnormal_mechanism&&(t.abnormal_mechanism=e.abnormal_mechanism),e.ignoreDuration&&(t.ignoreDuration=e.ignoreDuration),e.sid&&(t.sid=e.sid.length===32?e.sid:z()),e.init!==void 0&&(t.init=e.init),!t.did&&e.did&&(t.did=`${e.did}`),typeof e.started=="number"&&(t.started=e.started),t.ignoreDuration)t.duration=void 0;else if(typeof e.duration=="number")t.duration=e.duration;else{const n=t.timestamp-t.started;t.duration=n>=0?n:0}e.release&&(t.release=e.release),e.environment&&(t.environment=e.environment),!t.ipAddress&&e.ipAddress&&(t.ipAddress=e.ipAddress),!t.userAgent&&e.userAgent&&(t.userAgent=e.userAgent),typeof e.errors=="number"&&(t.errors=e.errors),e.status&&(t.status=e.status)}function le(t,e,n=2){if(!e||typeof e!="object"||n<=0)return e;if(t&&Object.keys(e).length===0)return t;const r={...t};for(const i in e)Object.prototype.hasOwnProperty.call(e,i)&&(r[i]=le(r[i],e[i],n-1));return r}function rt(){return z()}function Pt(){return z().substring(16)}const ye="_sentrySpan";function it(t,e){e?br(t,ye,e):delete t[ye]}function ne(t){return t[ye]}const _r=100;class C{constructor(){this._notifyingListeners=!1,this._scopeListeners=[],this._eventProcessors=[],this._breadcrumbs=[],this._attachments=[],this._user={},this._tags={},this._attributes={},this._extra={},this._contexts={},this._sdkProcessingMetadata={},this._propagationContext={traceId:rt(),sampleRand:ve()}}clone(){const e=new C;return e._breadcrumbs=[...this._breadcrumbs],e._tags={...this._tags},e._attributes={...this._attributes},e._extra={...this._extra},e._contexts={...this._contexts},this._contexts.flags&&(e._contexts.flags={values:[...this._contexts.flags.values]}),e._user=this._user,e._level=this._level,e._session=this._session,e._transactionName=this._transactionName,e._fingerprint=this._fingerprint,e._eventProcessors=[...this._eventProcessors],e._attachments=[...this._attachments],e._sdkProcessingMetadata={...this._sdkProcessingMetadata},e._propagationContext={...this._propagationContext},e._client=this._client,e._lastEventId=this._lastEventId,e._conversationId=this._conversationId,it(e,ne(this)),e}setClient(e){this._client=e}setLastEventId(e){this._lastEventId=e}getClient(){return this._client}lastEventId(){return this._lastEventId}addScopeListener(e){this._scopeListeners.push(e)}addEventProcessor(e){return this._eventProcessors.push(e),this}setUser(e){return this._user=e||{email:void 0,id:void 0,ip_address:void 0,username:void 0},this._session&&wr(this._session,{user:e}),this._notifyScopeListeners(),this}getUser(){return this._user}setConversationId(e){return this._conversationId=e||void 0,this._notifyScopeListeners(),this}setTags(e){return this._tags={...this._tags,...e},this._notifyScopeListeners(),this}setTag(e,n){return this.setTags({[e]:n})}setAttributes(e){return this._attributes={...this._attributes,...e},this._notifyScopeListeners(),this}setAttribute(e,n){return this.setAttributes({[e]:n})}removeAttribute(e){return e in this._attributes&&(delete this._attributes[e],this._notifyScopeListeners()),this}setExtras(e){return this._extra={...this._extra,...e},this._notifyScopeListeners(),this}setExtra(e,n){return this._extra={...this._extra,[e]:n},this._notifyScopeListeners(),this}setFingerprint(e){return this._fingerprint=e,this._notifyScopeListeners(),this}setLevel(e){return this._level=e,this._notifyScopeListeners(),this}setTransactionName(e){return this._transactionName=e,this._notifyScopeListeners(),this}setContext(e,n){return n===null?delete this._contexts[e]:this._contexts[e]=n,this._notifyScopeListeners(),this}setSession(e){return e?this._session=e:delete this._session,this._notifyScopeListeners(),this}getSession(){return this._session}update(e){if(!e)return this;const n=typeof e=="function"?e(this):e,r=n instanceof C?n.getScopeData():fr(n)?e:void 0,{tags:i,attributes:s,extra:l,user:a,contexts:u,level:o,fingerprint:c=[],propagationContext:p,conversationId:h}=r||{};return this._tags={...this._tags,...i},this._attributes={...this._attributes,...s},this._extra={...this._extra,...l},this._contexts={...this._contexts,...u},a&&Object.keys(a).length&&(this._user=a),o&&(this._level=o),c.length&&(this._fingerprint=c),p&&(this._propagationContext=p),h&&(this._conversationId=h),this}clear(){return this._breadcrumbs=[],this._tags={},this._attributes={},this._extra={},this._user={},this._contexts={},this._level=void 0,this._transactionName=void 0,this._fingerprint=void 0,this._session=void 0,this._conversationId=void 0,it(this,void 0),this._attachments=[],this.setPropagationContext({traceId:rt(),sampleRand:ve()}),this._notifyScopeListeners(),this}addBreadcrumb(e,n){var s;const r=typeof n=="number"?n:_r;if(r<=0)return this;const i={timestamp:Mt(),...e,message:e.message?kr(e.message,2048):e.message};return this._breadcrumbs.push(i),this._breadcrumbs.length>r&&(this._breadcrumbs=this._breadcrumbs.slice(-r),(s=this._client)==null||s.recordDroppedEvent("buffer_overflow","log_item")),this._notifyScopeListeners(),this}getLastBreadcrumb(){return this._breadcrumbs[this._breadcrumbs.length-1]}clearBreadcrumbs(){return this._breadcrumbs=[],this._notifyScopeListeners(),this}addAttachment(e){return this._attachments.push(e),this}clearAttachments(){return this._attachments=[],this}getScopeData(){return{breadcrumbs:this._breadcrumbs,attachments:this._attachments,contexts:this._contexts,tags:this._tags,attributes:this._attributes,extra:this._extra,user:this._user,level:this._level,fingerprint:this._fingerprint||[],eventProcessors:this._eventProcessors,propagationContext:this._propagationContext,sdkProcessingMetadata:this._sdkProcessingMetadata,transactionName:this._transactionName,span:ne(this),conversationId:this._conversationId}}setSDKProcessingMetadata(e){return this._sdkProcessingMetadata=le(this._sdkProcessingMetadata,e,2),this}setPropagationContext(e){return this._propagationContext=e,this}getPropagationContext(){return this._propagationContext}captureException(e,n){const r=(n==null?void 0:n.event_id)||z();if(!this._client)return w&&R.warn("No client configured on scope - will not capture exception!"),r;const i=new Error("Sentry syntheticException");return this._client.captureException(e,{originalException:e,syntheticException:i,...n,event_id:r},this),r}captureMessage(e,n,r){const i=(r==null?void 0:r.event_id)||z();if(!this._client)return w&&R.warn("No client configured on scope - will not capture message!"),i;const s=(r==null?void 0:r.syntheticException)??new Error(e);return this._client.captureMessage(e,n,{originalException:e,syntheticException:s,...r,event_id:i},this),i}captureEvent(e,n){const r=(n==null?void 0:n.event_id)||z();return this._client?(this._client.captureEvent(e,{...n,event_id:r},this),r):(w&&R.warn("No client configured on scope - will not capture event!"),r)}_notifyScopeListeners(){this._notifyingListeners||(this._notifyingListeners=!0,this._scopeListeners.forEach(e=>{e(this)}),this._notifyingListeners=!1)}}function Sr(){return Z("defaultCurrentScope",()=>new C)}function Tr(){return Z("defaultIsolationScope",()=>new C)}class Er{constructor(e,n){let r;e?r=e:r=new C;let i;n?i=n:i=new C,this._stack=[{scope:r}],this._isolationScope=i}withScope(e){const n=this._pushScope();let r;try{r=e(n)}catch(i){throw this._popScope(),i}return gr(r)?r.then(i=>(this._popScope(),i),i=>{throw this._popScope(),i}):(this._popScope(),r)}getClient(){return this.getStackTop().client}getScope(){return this.getStackTop().scope}getIsolationScope(){return this._isolationScope}getStackTop(){return this._stack[this._stack.length-1]}_pushScope(){const e=this.getScope().clone();return this._stack.push({client:this.getClient(),scope:e}),e}_popScope(){return this._stack.length<=1?!1:!!this._stack.pop()}}function B(){const t=U(),e=Me(t);return e.stack=e.stack||new Er(Sr(),Tr())}function Cr(t){return B().withScope(t)}function Rr(t,e){const n=B();return n.withScope(()=>(n.getStackTop().scope=t,e(t)))}function st(t){return B().withScope(()=>t(B().getIsolationScope()))}function Lr(){return{withIsolationScope:st,withScope:Cr,withSetScope:Rr,withSetIsolationScope:(t,e)=>st(e),getCurrentScope:()=>B().getScope(),getIsolationScope:()=>B().getIsolationScope()}}function ce(t){const e=Me(t);return e.acs?e.acs:Lr()}function Y(){const t=U();return ce(t).getCurrentScope()}function Be(){const t=U();return ce(t).getIsolationScope()}function Ar(){return Z("globalScope",()=>new C)}function Ir(...t){const e=U(),n=ce(e);if(t.length===2){const[r,i]=t;return r?n.withSetScope(r,i):n.withScope(i)}return n.withScope(t[0])}function Oe(){return Y().getClient()}function $r(t){const e=t.getPropagationContext(),{traceId:n,parentSpanId:r,propagationSpanId:i}=e,s={trace_id:n,span_id:i||Pt()};return r&&(s.parent_span_id=r),s}const Mr="sentry.source",Pr="sentry.sample_rate",Nr="sentry.previous_trace_sample_rate",zr="sentry.op",Br="sentry.origin",Or=0,Dr=1,qr="_sentryScope",Hr="_sentryIsolationScope";function jr(t){if(t){if(typeof t=="object"&&"deref"in t&&typeof t.deref=="function")try{return t.deref()}catch{return}return t}}function Nt(t){const e=t;return{scope:e[qr],isolationScope:jr(e[Hr])}}const Gr="sentry-",Fr=/^sentry-/;function Ur(t){const e=Zr(t);if(!e)return;const n=Object.entries(e).reduce((r,[i,s])=>{if(i.match(Fr)){const l=i.slice(Gr.length);r[l]=s}return r},{});if(Object.keys(n).length>0)return n}function Zr(t){if(!(!t||!dr(t)&&!Array.isArray(t)))return Array.isArray(t)?t.reduce((e,n)=>{const r=at(n);return Object.entries(r).forEach(([i,s])=>{e[i]=s}),e},{}):at(t)}function at(t){return t.split(",").map(e=>{const n=e.indexOf("=");if(n===-1)return[];const r=e.slice(0,n),i=e.slice(n+1);return[r,i].map(s=>{try{return decodeURIComponent(s.trim())}catch{return}})}).reduce((e,[n,r])=>(n&&r&&(e[n]=r),e),{})}const Yr=/^o(\d+)\./;function Wr(t,e=!1){const{host:n,path:r,pass:i,port:s,projectId:l,protocol:a,publicKey:u}=t;return`${a}://${u}${e&&i?`:${i}`:""}@${n}${s?`:${s}`:""}/${r&&`${r}/`}${l}`}function Vr(t){const e=t.match(Yr);return e==null?void 0:e[1]}function Kr(t){const e=t.getOptions(),{host:n}=t.getDsn()||{};let r;return e.orgId?r=String(e.orgId):n&&(r=Vr(n)),r}const zt=1;function Qr(t){const{spanId:e,traceId:n,isRemote:r}=t.spanContext(),i=r?e:Bt(t).parent_span_id,s=Nt(t).scope,l=r?(s==null?void 0:s.getPropagationContext().propagationSpanId)||Pt():e;return{parent_span_id:i,span_id:l,trace_id:n}}function Xr(t){if(t&&t.length>0)return t.map(({context:{spanId:e,traceId:n,traceFlags:r,...i},attributes:s})=>({span_id:e,trace_id:n,sampled:r===zt,attributes:s,...i}))}function ot(t){return typeof t=="number"?lt(t):Array.isArray(t)?t[0]+t[1]/1e9:t instanceof Date?lt(t.getTime()):ze()}function lt(t){return t>9999999999?t/1e3:t}function Bt(t){var r;if(ei(t))return t.getSpanJSON();const{spanId:e,traceId:n}=t.spanContext();if(Jr(t)){const{attributes:i,startTime:s,name:l,endTime:a,status:u,links:o}=t,c="parentSpanId"in t?t.parentSpanId:"parentSpanContext"in t?(r=t.parentSpanContext)==null?void 0:r.spanId:void 0;return{span_id:e,trace_id:n,data:i,description:l,parent_span_id:c,start_timestamp:ot(s),timestamp:ot(a)||void 0,status:ni(u),op:i[zr],origin:i[Br],links:Xr(o)}}return{span_id:e,trace_id:n,start_timestamp:0,data:{}}}function Jr(t){const e=t;return!!e.attributes&&!!e.startTime&&!!e.name&&!!e.endTime&&!!e.status}function ei(t){return typeof t.getSpanJSON=="function"}function ti(t){const{traceFlags:e}=t.spanContext();return e===zt}function ni(t){if(!(!t||t.code===Or))return t.code===Dr?"ok":t.message||"internal_error"}const ri="_sentryRootSpan";function ii(t){return t[ri]||t}function si(){const t=U(),e=ce(t);return e.getActiveSpan?e.getActiveSpan():ne(Y())}function ai(t){var n;if(typeof __SENTRY_TRACING__=="boolean"&&!__SENTRY_TRACING__)return!1;const e=(n=Oe())==null?void 0:n.getOptions();return!!e&&(e.tracesSampleRate!=null||!!e.tracesSampler)}const oi="production",li="_frozenDsc";function Ot(t,e){const n=e.getOptions(),{publicKey:r}=e.getDsn()||{},i={environment:n.environment||oi,release:n.release,public_key:r,trace_id:t,org_id:Kr(e)};return e.emit("createDsc",i),i}function ci(t,e){const n=e.getPropagationContext();return n.dsc||Ot(n.traceId,t)}function ui(t){var d;const e=Oe();if(!e)return{};const n=ii(t),r=Bt(n),i=r.data,s=n.spanContext().traceState,l=(s==null?void 0:s.get("sentry.sample_rate"))??i[Pr]??i[Nr];function a(k){return(typeof l=="number"||typeof l=="string")&&(k.sample_rate=`${l}`),k}const u=n[li];if(u)return a(u);const o=s==null?void 0:s.get("sentry.dsc"),c=o&&Ur(o);if(c)return a(c);const p=Ot(t.spanContext().traceId,e),h=i[Mr],b=r.description;return h!=="url"&&b&&(p.transaction=b),ai()&&(p.sampled=String(ti(n)),p.sample_rand=(s==null?void 0:s.get("sentry.sample_rand"))??((d=Nt(n).scope)==null?void 0:d.getPropagationContext().sampleRand.toString())),a(p),e.emit("createDsc",p,n),p}function hi(t,e=[]){return[t,e]}function ct(t,e){const{extra:n,tags:r,attributes:i,user:s,contexts:l,level:a,sdkProcessingMetadata:u,breadcrumbs:o,fingerprint:c,eventProcessors:p,attachments:h,propagationContext:b,transactionName:d,span:k}=e;H(t,"extra",n),H(t,"tags",r),H(t,"attributes",i),H(t,"user",s),H(t,"contexts",l),t.sdkProcessingMetadata=le(t.sdkProcessingMetadata,u,2),a&&(t.level=a),d&&(t.transactionName=d),k&&(t.span=k),o.length&&(t.breadcrumbs=[...t.breadcrumbs,...o]),c.length&&(t.fingerprint=[...t.fingerprint,...c]),p.length&&(t.eventProcessors=[...t.eventProcessors,...p]),h.length&&(t.attachments=[...t.attachments,...h]),t.propagationContext={...t.propagationContext,...b}}function H(t,e,n){t[e]=le(t[e],n,1)}function pi(t,e){const n=Ar().getScopeData();return t&&ct(n,t.getScopeData()),e&&ct(n,e.getScopeData()),n}function di(t){if(t)return fi(t)?{captureContext:t}:bi(t)?{captureContext:t}:t}function fi(t){return t instanceof C||typeof t=="function"}const gi=["user","level","extra","contexts","tags","fingerprint","propagationContext"];function bi(t){return Object.keys(t).some(e=>gi.includes(e))}function mi(t,e){return Y().captureException(t,di(e))}function ki(t,e){const n=typeof e=="string"?e:void 0,r=typeof e!="string"?{captureContext:e}:void 0;return Y().captureMessage(t,n,r)}function xi(t,e){Be().setContext(t,e)}function we(t,e){Be().setTag(t,e)}function vi(t){return typeof t=="object"&&t!=null&&!Array.isArray(t)&&Object.keys(t).includes("value")}function yi(t,e){const{value:n,unit:r}=vi(t)?t:{value:t,unit:void 0},i=wi(n),s=r&&typeof r=="string"?{unit:r}:{};if(i)return{...i,...s};if(!e||e==="skip-undefined"&&n===void 0)return;let l="";try{l=JSON.stringify(n)??""}catch{}return{value:l,type:"string",...s}}function ut(t,e=!1){const n={};for(const[r,i]of Object.entries(t??{})){const s=yi(i,e);s&&(n[r]=s)}return n}function wi(t){const e=typeof t=="string"?"string":typeof t=="boolean"?"boolean":typeof t=="number"&&!Number.isNaN(t)?Number.isInteger(t)?"integer":"double":null;if(e)return{value:t,type:e}}function _i(t,e){return e?Ir(e,()=>{const n=si(),r=n?Qr(n):$r(e);return[n?ui(n):ci(t,e),r]}):[void 0,void 0]}function Si(t){return[{type:"trace_metric",item_count:t.length,content_type:"application/vnd.sentry.items.trace-metric+json"},{items:t}]}function Ti(t,e,n,r){const i={};return e!=null&&e.sdk&&(i.sdk={name:e.sdk.name,version:e.sdk.version}),n&&r&&(i.dsn=Wr(r)),hi(i,[Si(t)])}const Ei=1e3;function _(t,e,n,r=!0){n&&(r||!(e in t))&&(t[e]=n)}function Ci(t,e){const n=De(),r=Dt(t);r===void 0?n.set(t,[e]):r.length>=Ei?(Ii(t,r),n.set(t,[e])):n.set(t,[...r,e])}function Ri(t,e,n){var c;const{release:r,environment:i}=e.getOptions(),s={...t.attributes};_(s,"user.id",n.id,!1),_(s,"user.email",n.email,!1),_(s,"user.name",n.username,!1),_(s,"sentry.release",r),_(s,"sentry.environment",i);const{name:l,version:a}=((c=e.getSdkMetadata())==null?void 0:c.sdk)??{};_(s,"sentry.sdk.name",l),_(s,"sentry.sdk.version",a);const u=e.getIntegrationByName("Replay"),o=u==null?void 0:u.getReplayId(!0);return _(s,"sentry.replay_id",o),o&&(u==null?void 0:u.getRecordingMode())==="buffer"&&_(s,"sentry._internal.replay_is_buffering",!0),{...t,attributes:s}}function Li(t,e,n,r){const[,i]=_i(e,n),s=ne(n),l=s?s.spanContext().traceId:i==null?void 0:i.trace_id,a=s?s.spanContext().spanId:void 0;return{timestamp:ze(),trace_id:l??"",span_id:a,name:t.name,type:t.type,unit:t.unit,value:t.value,attributes:{...ut(r),...ut(t.attributes,"skip-undefined")}}}function Ai(t,e){const n=Y(),r=(e==null?void 0:e.captureSerializedMetric)??Ci,i=(n==null?void 0:n.getClient())??Oe();if(!i){w&&R.warn("No client available to capture metric.");return}const{_experiments:s,enableMetrics:l,beforeSendMetric:a}=i.getOptions();if(!(l??(s==null?void 0:s.enableMetrics)??!0)){w&&R.warn("metrics option not enabled, metric will not be captured.");return}const{user:o,attributes:c}=pi(Be(),n),p=Ri(t,i,o);i.emit("processMetric",p);const h=a||(s==null?void 0:s.beforeSendMetric),b=h?h(p):p;if(!b){w&&R.log("`beforeSendMetric` returned `null`, will not send metric.");return}const d=Li(b,i,n,c);w&&R.log("[Metric]",d),r(i,d),i.emit("afterCaptureMetric",b)}function Ii(t,e){const n=e??Dt(t)??[];if(n.length===0)return;const r=t.getOptions(),i=Ti(n,r._metadata,r.tunnel,t.getDsn());De().set(t,[]),t.emit("flushMetrics"),t.sendEnvelope(i)}function Dt(t){return De().get(t)}function De(){return Z("clientToMetricBufferMap",()=>new WeakMap)}function $i(t,e,n,r){Ai({type:t,name:e,value:n,unit:r==null?void 0:r.unit,attributes:r==null?void 0:r.attributes},{})}function Mi(t,e,n){$i("gauge",t,e,n)}var _e,qt=-1,W=function(t){addEventListener("pageshow",(function(e){e.persisted&&(qt=e.timeStamp,t(e))}),!0)},Ht=function(){return window.performance&&performance.getEntriesByType&&performance.getEntriesByType("navigation")[0]},qe=function(){var t=Ht();return t&&t.activationStart||0},L=function(t,e){var n=Ht(),r="navigate";return qt>=0?r="back-forward-cache":n&&(document.prerendering||qe()>0?r="prerender":document.wasDiscarded?r="restore":n.type&&(r=n.type.replace(/_/g,"-"))),{name:t,value:e===void 0?-1:e,rating:"good",delta:0,entries:[],id:"v3-".concat(Date.now(),"-").concat(Math.floor(8999999999999*Math.random())+1e12),navigationType:r}},V=function(t,e,n){try{if(PerformanceObserver.supportedEntryTypes.includes(t)){var r=new PerformanceObserver((function(i){Promise.resolve().then((function(){e(i.getEntries())}))}));return r.observe(Object.assign({type:t,buffered:!0},n||{})),r}}catch{}},A=function(t,e,n,r){var i,s;return function(l){e.value>=0&&(l||r)&&((s=e.value-(i||0))||i===void 0)&&(i=e.value,e.delta=s,e.rating=(function(a,u){return a>u[1]?"poor":a>u[0]?"needs-improvement":"good"})(e.value,n),t(e))}},He=function(t){requestAnimationFrame((function(){return requestAnimationFrame((function(){return t()}))}))},je=function(t){var e=function(n){n.type!=="pagehide"&&document.visibilityState!=="hidden"||t(n)};addEventListener("visibilitychange",e,!0),addEventListener("pagehide",e,!0)},jt=function(t){var e=!1;return function(n){e||(t(n),e=!0)}},P=-1,ht=function(){return document.visibilityState!=="hidden"||document.prerendering?1/0:0},re=function(t){document.visibilityState==="hidden"&&P>-1&&(P=t.type==="visibilitychange"?t.timeStamp:0,Pi())},pt=function(){addEventListener("visibilitychange",re,!0),addEventListener("prerenderingchange",re,!0)},Pi=function(){removeEventListener("visibilitychange",re,!0),removeEventListener("prerenderingchange",re,!0)},Gt=function(){return P<0&&(P=ht(),pt(),W((function(){setTimeout((function(){P=ht(),pt()}),0)}))),{get firstHiddenTime(){return P}}},Ge=function(t){document.prerendering?addEventListener("prerenderingchange",(function(){return t()}),!0):t()},dt=[1800,3e3],Ni=function(t,e){e=e||{},Ge((function(){var n,r=Gt(),i=L("FCP"),s=V("paint",(function(l){l.forEach((function(a){a.name==="first-contentful-paint"&&(s.disconnect(),a.startTime<r.firstHiddenTime&&(i.value=Math.max(a.startTime-qe(),0),i.entries.push(a),n(!0)))}))}));s&&(n=A(t,i,dt,e.reportAllChanges),W((function(l){i=L("FCP"),n=A(t,i,dt,e.reportAllChanges),He((function(){i.value=performance.now()-l.timeStamp,n(!0)}))})))}))},ft=[.1,.25],zi=function(t,e){e=e||{},Ni(jt((function(){var n,r=L("CLS",0),i=0,s=[],l=function(u){u.forEach((function(o){if(!o.hadRecentInput){var c=s[0],p=s[s.length-1];i&&o.startTime-p.startTime<1e3&&o.startTime-c.startTime<5e3?(i+=o.value,s.push(o)):(i=o.value,s=[o])}})),i>r.value&&(r.value=i,r.entries=s,n())},a=V("layout-shift",l);a&&(n=A(t,r,ft,e.reportAllChanges),je((function(){l(a.takeRecords()),n(!0)})),W((function(){i=0,r=L("CLS",0),n=A(t,r,ft,e.reportAllChanges),He((function(){return n()}))})),setTimeout(n,0))})))},Ft=0,de=1/0,Q=0,Bi=function(t){t.forEach((function(e){e.interactionId&&(de=Math.min(de,e.interactionId),Q=Math.max(Q,e.interactionId),Ft=Q?(Q-de)/7+1:0)}))},Ut=function(){return _e?Ft:performance.interactionCount||0},Oi=function(){"interactionCount"in performance||_e||(_e=V("event",Bi,{type:"event",buffered:!0,durationThreshold:0}))},gt=[200,500],Zt=0,bt=function(){return Ut()-Zt},y=[],fe={},mt=function(t){var e=y[y.length-1],n=fe[t.interactionId];if(n||y.length<10||t.duration>e.latency){if(n)n.entries.push(t),n.latency=Math.max(n.latency,t.duration);else{var r={id:t.interactionId,latency:t.duration,entries:[t]};fe[r.id]=r,y.push(r)}y.sort((function(i,s){return s.latency-i.latency})),y.splice(10).forEach((function(i){delete fe[i.id]}))}},Di=function(t,e){e=e||{},Ge((function(){var n;Oi();var r,i=L("INP"),s=function(a){a.forEach((function(c){c.interactionId&&mt(c),c.entryType==="first-input"&&!y.some((function(p){return p.entries.some((function(h){return c.duration===h.duration&&c.startTime===h.startTime}))}))&&mt(c)}));var u,o=(u=Math.min(y.length-1,Math.floor(bt()/50)),y[u]);o&&o.latency!==i.value&&(i.value=o.latency,i.entries=o.entries,r())},l=V("event",s,{durationThreshold:(n=e.durationThreshold)!==null&&n!==void 0?n:40});r=A(t,i,gt,e.reportAllChanges),l&&("PerformanceEventTiming"in window&&"interactionId"in PerformanceEventTiming.prototype&&l.observe({type:"first-input",buffered:!0}),je((function(){s(l.takeRecords()),i.value<0&&bt()>0&&(i.value=0,i.entries=[]),r(!0)})),W((function(){y=[],Zt=Ut(),i=L("INP"),r=A(t,i,gt,e.reportAllChanges)})))}))},kt=[2500,4e3],ge={},qi=function(t,e){e=e||{},Ge((function(){var n,r=Gt(),i=L("LCP"),s=function(u){var o=u[u.length-1];o&&o.startTime<r.firstHiddenTime&&(i.value=Math.max(o.startTime-qe(),0),i.entries=[o],n())},l=V("largest-contentful-paint",s);if(l){n=A(t,i,kt,e.reportAllChanges);var a=jt((function(){ge[i.id]||(s(l.takeRecords()),l.disconnect(),ge[i.id]=!0,n(!0))}));["keydown","click"].forEach((function(u){addEventListener(u,(function(){return setTimeout(a,0)}),!0)})),je(a),W((function(u){i=L("LCP"),n=A(t,i,kt,e.reportAllChanges),He((function(){i.value=performance.now()-u.timeStamp,ge[i.id]=!0,n(!0)}))}))}}))};function Hi(){return console.warn("⚠️ VITE_SENTRY_DSN not set. Monitoring disabled."),!1}function ji(){const t=e=>{try{Mi(e.name,e.value),we("metric_id",e.id),we("metric_rating",e.rating)}catch{}};qi(t),zi(t),Di(t)}function Gi(){try{const t=ae();xi("page",{url:window.location.href,title:document.title,pageType:t.type}),we("pageType",t.type),ki(`Page View: ${document.title}`,{level:"info",tags:{pageType:t.type}})}catch{}}function Yt(t,e){try{mi(t,{tags:{location:e,pageType:ae().type},level:"error"})}catch{}}const Fi=Hi();Fi&&(Gi(),ji());async function Wt(){const t=ae();await Vn(),ir(t),t.showTableOfContents&&Qn(),t.showBreadcrumb&&await rr()}document.addEventListener("DOMContentLoaded",async()=>{try{await Wt()}catch(t){Yt(t,"DOMContentLoaded.initializePage"),console.error("❌ main.ts: DOMContentLoaded : 페이지 초기화 실패!",t)}});window.addEventListener("hashchange",async()=>{try{await Wt(),window.scrollTo(0,0)}catch(t){Yt(t,"hashchange.initializePage"),console.error("❌ main.ts: hashchange : 페이지 초기화 실패!",t)}});
//# sourceMappingURL=index-BHkI5QLW.js.map
